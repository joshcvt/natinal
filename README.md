...
# NOTE: As of the 2023 season, MLB has retired the GDX API this script runs against and has essentially no abstraction layer around. Future updates are not guaranteed.

(c) 2016-23 J. W. Crockett, Jr.<sup><a href="#footnote2">2</a></sup>, [@joshcvt](http://twitter.com/joshcvt)

**natinal** is a Python 3.9 script to monitor MLB.com GDX API data feeds.  Run as a cron job, it relays certain gameday events and highlight video links to a configured set of services.
